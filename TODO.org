...
* TODO Sometimes C-p and C-n skip a line                                :bug:
...
* DONE conditionally add packages to package list
  ...
  -
* TODO Fix client test marker in coffee files
...
* TODO Fix save mark to register/jump to register                       :bug:
...
* TODO w3m
  ...
  - try for gmail
* TODO dired: edit with, / shell commands
...
* TODO make ` a paired char
* TODO Octopress and Emacs

  - Want to:
    - create new write post with command
    - write post in MD or org
    - publish with Emacs command
  ...
  - Heroku
    - upgrade to heroku toolbelt
    - install heroku accounts plugin
    - spanishdict / wjb accounts
    -
