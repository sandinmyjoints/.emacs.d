...
(global-set-key "b" 'rename-buffer)
(global-set-key "\C-cp" 'python-mode)
(global-set-key "v" 'describe-variable)
(global-set-key "w" 'whitespace-mode)
(global-set-key "i" 'indent-relative)
(global-set-key "d" 'dirtree)
(global-set-key " " 'just-one-space)
(global-set-key "h" 'whack-whitespace)
(global-set-key "e" 'delete-trailing-whitespace)
